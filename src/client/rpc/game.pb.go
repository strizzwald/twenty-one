...
var fileDescriptor_38fc58335341d769 = []byte{
	...
	0x90, 0x51, 0x1d, 0x17, 0x0b, 0x48, 0x8b, 0x90, 0x15, 0x17, 0xbb, 0x5f, 0x6a, 0x39, 0x98, 0x29,
	0xa6, 0x57, 0x54, 0x90, 0xac, 0x87, 0xe1, 0x69, 0x29, 0x71, 0x0c, 0x71, 0xa8, 0x35, 0x56, 0x5c,
	0x9c, 0x70, 0xbb, 0x85, 0x44, 0xc1, 0xaa, 0xd0, 0x1d, 0x2e, 0x25, 0x86, 0x2e, 0x0c, 0xd1, 0x9b,
	0xc4, 0x06, 0x0e, 0x6a, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd2, 0x02, 0x09, 0x14, 0x78,
	0x01, 0x00, 0x00,
}
...
func (c *gameClient) StartGame(ctx context.Context, in *StartGameRequest, opts ...grpc.CallOption) (*StartGameResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rpc.Game/StartGame", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGameServer) StartGame(ctx context.Context, req *StartGameRequest) (*StartGameResponse, error) {
